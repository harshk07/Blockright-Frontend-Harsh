          ...
          >
            ...
            >
              ...
              <div className="md:flex items-center mt-14 py-8 border-t border-gray-200">
                <div className="w-1/4">
                  <img
                    src="https://printify.com/wp-content/uploads/2022/02/Print-NFT-Merchandise-on-Demand-Printify.jpg"
                    alt
              ...
              <div className="md:flex items-center py-8 border-t border-b border-gray-200">
                <div className="h-full w-1/4">
                  <img
                    src="https://i.pinimg.com/originals/c6/b0/4f/c6b04f466cde57badaa14ce147dd8364.jpg"
                    alt
                    className="w-full h-full object-center object-cover"
                  />
                </div>
